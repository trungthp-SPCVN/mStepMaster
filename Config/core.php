...
$bj_config = dirname(dirname(dirname(dirname(__FILE__))));
require_once $bj_config . "/bj_config.php";
...
Configure::write('debug', ((in_array(DEVELOP_MODE, array("local"))) ? 2 : 2));
...
Configure::write('Session', array(
	...
	"ini" => array(
		...
		"session.gc_maxlifetime" => 60 * 60 * 24 * $day,
		"session.save_path" => dirname(dirname(__FILE__)) . DS . "tmp" . DS . "sessions" . DS,
	),
));
 ...
 */
Configure::write('Security.cipherSeed', 'hayahidemax4561');
